        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="#!" runat="server" id="form2">
                  <div class="form-group">
                    <label for="email" class="sr-only">Email</label>
                    <input type="email" name="email" id="email" class="form-control" runat="server" placeholder="Email address">
                  </div>
                  <div class="form-group mb-4">
                    <label for="password" class="sr-only">Password</label>
                    <input type="password" name="password" id="password" runat="server" class="form-control" placeholder="Password">
                  </div>
                  <asp:Button  ID="btn1" CssClass="btn btn-block login-btn mb-4" runat="server" Text="Login" OnClick="btn1_click"/>
